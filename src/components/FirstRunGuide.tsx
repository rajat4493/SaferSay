...
export function FirstRunGuide() {
  ...
  const steps: Step[] = [
    ...
    { label: "Send it", body: "Send the confidential invite links so people can start responding.", href: hasCycle ? `/app/${state.cycle!.id}/send` : "/app/surveys/new", action: "Send invites" },
  ];
